...
FROM
  students s
  INNER JOIN food_choices f ON s.student_id = f.student_id;
...
---------------------------------------------------------------------------------
-- Question 1 - Implement an INNER JOIN between the loans and customers tables. -
---------------------------------------------------------------------------------
--
SELECT
  *
...
--
-----------------------------------------------------------------------------------------------
-- Question 2 - Implement an INNER JOIN between the employees and performance_reviews tables. -
-----------------------------------------------------------------------------------------------
--
SELECT
  *
...
--
---------------------------------------------------------------------------------------
-- Question 3 - Implement an INNER JOIN between the advertisers and campaigns tables. -
---------------------------------------------------------------------------------------
--
SELECT
  *
